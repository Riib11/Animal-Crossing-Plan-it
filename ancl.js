...
var ACNL = function() {
    ...
    function getCreator() {
        return utf16(0x2c, 20);
    };
    function getTown() {
        return utf16(0x42, 20);
    };
    ...
    function setCreator(str) {
        to_utf16(0x2c, 10, str);
    };
    function setTown(str) {
        to_utf16(0x42, 10, str);
    };

    function getWidth() {
        if (data.length == 0x870) {
            return 64;
        }
        return 32;
    };
    ...
    function qr(obj) {
        ...
        if (getWidth() == 64) {
            obj.qrcode({
                "correctLevel": 0,
                "text": data.substr(0, 0x21C),
                "render": "canvas",
                "width": 512,
                "height": 512,
                "multipart_num": 0,
                "multipart_total": 3,
                "multipart_parity": 0x77
            });
            obj.qrcode({
                "correctLevel": 0,
                "text": data.substr(0x21C, 0x21C),
                "render": "canvas",
                "width": 512,
                "height": 512,
                "multipart_num": 1,
            ...
            obj.qrcode({
                "correctLevel": 0,
                "text": data.substr(0x21C * 2, 0x21C),
                "render": "canvas",
                "width": 512,
                "height": 512,
                "multipart_num": 2,
            ...
            obj.qrcode({
                "correctLevel": 0,
                "text": data.substr(0x21C * 3, 0x21C),
                "render": "canvas",
                "width": 512,
                "height": 512,
                "multipart_num": 3,
    ...
    function setColor(x, y, c) {
        if (x < 0 || y < 0 || c < 0 || c > 15 || x > 63 || y > 63 || isNaN(x) || isNaN(y)) {
            return false;
        }
        if (data.length != 0x870 && (x > 31 || y > 31)) {
            return false;
        }
